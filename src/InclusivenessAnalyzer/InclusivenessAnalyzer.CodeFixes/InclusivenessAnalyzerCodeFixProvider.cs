...
{
    [ExportCodeFixProvider(LanguageNames.CSharp, Name = nameof(InclusivenessAnalyzerCodeFixProvider)), Shared]
    public class InclusivenessAnalyzerCodeFixProvider : CodeFixProvider
    {
